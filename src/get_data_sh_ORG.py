...
def get_stocklist():
    ...
    for i in range(1, 96):  # 96页
        ...
        url = 'http://73.push2.eastmoney.com/api/qt/clist/get?cb=jQuery112408013832830150123_161244\
        1015559&pn='+str(i)+'&pz=20&po=1&np=1&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=2&fid=f3&fs=m:1+t:2,m:1+t:23&\
...
def get_indiv_stock():
    ...
    for code in idx:
        try:
            ...
            url = 'http://quotes.money.163.com/service/chddata.\
            html?code=0'+str(code)+'&start=20060101&end=20210204&fields\
            =TCLOSE;HIGH;LOW;TOPEN;LCLOSE;CHG;PCHG;TURNOVER;VOTURNOVER;\
            VATURNOVER;TCAP;MCAP'   # TODO:每日更新日期
...
def save_db():
    ...
    for code in idx:
        try:
            ...
            print('正在获取股票%s数据' % code)
            url = 'http://quotes.money.163.com/service/chddata.\
            html?code=0'+str(code)+'&start=20060101&end=20210204&\
