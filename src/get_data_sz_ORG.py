...
def get_stocklist():
    ...
    for i in range(1, 124):  # 124页
        ...
        jQuery112405729827281650932_1612450709581&pn='+str(i)+'&pz=20&po=1&np=1&ut=\
        bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=2&fid=f3&\
        fs=m:0+t:6,m:0+t:13,m:0+t:80&fields=f1,f2,f3,f4,f5,f6,f7,\
        f8,f9,f10,f12,f13,f14,f15,f16,f17,f18,f20,f21,f23,f24,f25,\
        f22,f11,f62,f128,f136,f115,f152&_=1612450709582'
...
def get_indiv_stock():
    ...
    for code in idx:
        try:
            ...
            code=1'+str(code)+'&start=20060101&end=20210204&fields=\
