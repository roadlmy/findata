...
for code in idx:
   ...
   url = 'http://quotes.money.163.com/service/chddata.html?code=1'+str(code)+'&start=20201016&end=20210204&fields=TCLOSE;HIGH;LOW;TOPEN;LCLOSE;CHG;PCHG;TURNOVER;VOTURNOVER;VATURNOVER;TCAP;MCAP'   ####TODO:每日更新日期
